...
useHead({
	...
	meta: [
		{ name: "description", content: "Read articles about web development, programming, and technology written by Jässin ***REMOVED***." },
		{ name: "og:title", content: "Blog - probablyjassin" },
		{ name: "og:description", content: "Read articles about web development, programming, and technology written by Jässin ***REMOVED***." },
		{ name: "og:type", content: "website" },
		{ name: "twitter:card", content: "summary" },
		{ name: "twitter:title", content: "Blog - probablyjassin" },
		{ name: "twitter:description", content: "Read articles about web development, programming, and technology written by Jässin ***REMOVED***." },
	],
});
